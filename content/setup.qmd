...
If you use **Option A (Docker)**, all required packages are already included in the
workshop image and you can skip installation.
...
Install these only if you want to explore modules outside Unit 00 and Unit 01.
