...
help connect the results back to the main IPD ideas.
...
Unit 00 uses synthetic examples on purpose. The goal is to make the IPD
...
were the true observed outcomes can bias downstream inference. IPD methods use
a small labeled set to correct that bias while still borrowing information from
unlabeled data and predictions.
...
4. **Compare** naive, classical, and IPD-based estimates.
...
### Exercise 5: IPD Model Fitting via the Chen + Chen Estimator
